...
| <a name="input_karpenter_iam_role_policy_name_prefix_enabled"></a> [karpenter\_iam\_role\_policy\_name\_prefix\_enabled](#input\_karpenter\_iam\_role\_policy\_name\_prefix\_enabled) | Boolean flag to enable/disable using name prefix for karpenter iam role policy | `bool` | `false` | no |
